...
<div class="content-wrapper">
    <div
        class="flex flex-col max-w-sm p-6 bg-white border border-gray-200 gap-3 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <div class="flex flex-row gap-5">
            ...
            <div class="flex flex-col gap-1">
                <a href="#">
                    <h4 class="heading4">Add
                        new
                        user
                    </h4>
                </a>
                <p class="paragraph">Create new user</p>
            </div>
        </div>
